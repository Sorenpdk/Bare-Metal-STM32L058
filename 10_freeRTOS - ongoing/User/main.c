...
void myTask1(void *p)
{
  ...
  { 
    ...
    for(uint32_t i = 0; i < 500000; i++ ); // Long blocking delay
    vTaskDelay(1000);
  }
...
int main(void)
{
  ...
  xTaskCreate(myTask1,"Blinky", 200, (void*)0, tskIDLE_PRIORITY, &myTask1Handle);
  xTaskCreate(myTask2,"USART", 20, (void*)0, tskIDLE_PRIORITY+1, &myTask2Handle);
