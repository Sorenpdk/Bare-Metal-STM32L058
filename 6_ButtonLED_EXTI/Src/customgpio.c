...
void customGPIO_init(void)
{
    ...
    RCC->IOPENR |= RCC_IOPENR_IOPAEN | RCC_IOPENR_IOPCEN; /* (1) */
  ...
  /**********************************************************************
   ** 		EXTI13 Configurations PC13		 **
   **********************************************************************/
  // MODER Reset value 0xFFFF FFFF for the other ports
  // PUPD Reset value 0x0000 0000 for the other ports
  GPIOC->MODER &= ~(GPIO_MODER_MODE13_1 | GPIO_MODER_MODE13_0);
